...
// ahool-UTM - 2016-2023 - ahool TECNOLOGIA EPP, All rights reserved.
...
//        define('LDAP_OPT_DIAGNOSTIC_MESSAGE', 0x0032);  //Already defined in PHP 5.x  versions
      ...
      //determine the LDAP Path from Active Directory details
		...
		// INIT OF SQL CODE
		class ahooldb extends SQLite3 {
			function __construct() {
				$this->open('/root/ahoolid.db');
			}
		}
		...
		$sql =<<<EOF
		REPLACE INTO ahoolid VALUES ('$srcip', '$user_final', '$timestamp');
		EOF;
...
?>
<!DOCTYPE html><head><title>AHOOL</title></head>
<style>
...
<br/>
<img id="imghdr" src="/new-ahool-logo1.png"/>
...
<div title="AHOOL Enter your credentials" style="width:400px" id="loginbox">
